...
set "MOD_CONTROLS=Controls:&echo   Home      - Recenter head tracking&echo   End       - Toggle head tracking on/off&echo   Page Up   - Cycle tracking mode&echo   Insert    - Toggle yaw mode (world/local)&echo   Page Down - Cycle UDP port (4242-4245)"
:: --- END CONFIG BLOCK ---
