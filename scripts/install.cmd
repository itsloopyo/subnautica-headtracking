...
set "MOD_CONTROLS=Controls:&echo   Home    - Recenter head tracking&echo   End     - Toggle head tracking on/off&echo   Page Up - Cycle tracking mode&echo   Insert  - Toggle yaw mode (world/local)"
:: --- END CONFIG BLOCK ---
